...
const shoppingCartSlice = createSlice({
    ...
    extraReducers: (bulter) => {
        bulter.addCase(fetchShoppingCart.fulfilled, (state, action) => action.payload);
        bulter.addCase(removeFromCart.fulfilled, (state, action) => action.payload);
        bulter.addCase(clearCart.fulfilled, (state, action) => action.payload);
    }
})
